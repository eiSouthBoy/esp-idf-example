...
// bind_key: 0x231d39c1d7cc1ab1aee224cd096db932
...
static const uint8_t local_mac[] = {0x90, 0x15, 0x06, 0x7c, 0x1b, 0x66};
// static const uint8_t peer_mac[] = { 0x54, 0x48, 0xE6, 0x8F, 0x80, 0xA6};
static const uint8_t peer_mac[] = {0x90, 0x15, 0x06, 0x7c, 0x1e, 0x66};
...
{
    ESP_LOGI(TAG, "button number: %d, button active level: %d", 
            CONFIG_EXAMPLE_BUTTON_IO_NUM, 
            CONFIG_EXAMPLE_BUTTON_ACTIVE_LEVEL);
